# Diagrid CrewAI Extension Examples
...
A basic example demonstrating a CrewAI agent with tools running as durable Dapr Workflow activities:
...
The examples demonstrate how CrewAI tool executions are run as durable Dapr Workflow activities:
