# Diagrid Agent CrewAI Extension

This is the Diagrid Agent extension for CrewAI agents using Dapr Workflows.
...
```python
result = runner.run_sync(task=task, session_id="session-123", timeout=300)
