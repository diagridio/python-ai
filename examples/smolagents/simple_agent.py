...
"""
Example: Simple smolagents Agent with Dapr Workflows

This example demonstrates how to run a smolagents ToolCallingAgent with
durable execution using Dapr Workflows. Each model call and each tool
...
Prerequisites:
    ...
    2. Required packages: uv sync --all-packages --extra smolagents
...
async def main():
    """Run the smolagents agent as a Dapr workflow."""

    # Build the agent as usual - smolagents native construction
