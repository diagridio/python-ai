...
"""
Test script to verify Dapr workflow crash recovery for smolagents agents.
...
STATE_FILE = Path("/tmp/smolagents_crash_test_state.json")
...
async def poll_for_completion(runner: DaprWorkflowAgentRunner, workflow_id: str):
    ...
    from diagrid.agent.smolagents.models import AgentWorkflowOutput
