...
"""Tests for LangChain DaprSessionStore."""
...
class TestDaprSessionStore(TestCase):
    ...
    def test_load_session(self):
        ...
        mock_ss.get.assert_called_once_with("langchain-sess-1-state")
    ...
    def test_delete_session(self):
        ...
        mock_ss.delete.assert_called_once_with("langchain-sess-1-state")
