...
"""Tests for smolagents DaprSessionStore."""
...
class TestDaprSessionStore(TestCase):
    ...
    def test_save_session(self):
        ...
        store.save_session("sess-1", {"messages": ["hi"]})

        mock_ss.save.assert_called_once_with(
            "smolagents-sess-1-state",
            {"messages": ["hi"]},
        )
    ...
    def test_load_session(self):
        ...
        mock_ss.get.assert_called_once_with("smolagents-sess-1-state")
    ...
    def test_delete_session(self):
        ...
        mock_ss.delete.assert_called_once_with("smolagents-sess-1-state")
