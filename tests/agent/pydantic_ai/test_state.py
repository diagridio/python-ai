...
"""Tests for Pydantic AI DaprMemoryStore."""
...
class TestDaprMemoryStore(TestCase):
    ...
    def test_load_memory(self):
        ...
        mock_ss.get.assert_called_once_with("pydantic-ai-sess-1-memory")
    ...
    def test_delete_memory(self):
        ...
        mock_ss.delete.assert_called_once_with("pydantic-ai-sess-1-memory")
